...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // On vérifie qu'il y a au moins un ingrédient et une étape valides
    $ingredients_valides = [];
    ...
    if ($erreur === '') {
        try {
            ...
            // 3. Insérer les ingrédients (en créant l'ingrédient s'il n'existe pas encore)
...
<script>
    ...
    // On démarre avec 3 lignes d'ingrédients et 2 lignes d'étapes par défaut
    addRow('ingredients-container', 'template-ingredient');
    addRow('ingredients-container', 'template-ingredient');
    addRow('ingredients-container', 'template-ingredient');
    addRow('etapes-container', 'template-etape');
